...
class ProfesssionalAddFrontCnicPage extends StatefulWidget {
  @override
  _ProfesssionalAddFrontCnicPageState createState() =>
      _ProfesssionalAddFrontCnicPageState();
}

class _ProfesssionalAddFrontCnicPageState extends State<ProfesssionalAddFrontCnicPage> {
  i.File _image;
              ...
              children: <Widget>[
                ...
                _image == null ? Center(
                  child: Container(
                    width: 280.0,
                    height: 200.0,
                    child: Image.asset('images/CNIC-Nadra-Front.jpg'),
                  ),
                ):Center(
                  child: Container(
                    width: 300.0,
